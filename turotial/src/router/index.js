...
export const bussinessRouterMap = [{
        ...
        children: [{
            ...
            },
            {
                ...
                children: [{
                        ...
                        path: "qq",
                        component: () =>
                            import ("views/auth/qq")
                    },
                    {
                        name: "4A验证",
                        path: "4a",
                        component: () =>
                            import ("views/auth/4a")
                    },
                    {
                        name: "Form验证",
                        path: "form",
                        component: () =>
                            import ("views/auth/form")
                    }
                ]
            },
            {
    ...
    },
    {
        ...
        path: "/geoAnalysis",
        component: () =>
            import ("views/geoAnalysis")
    },
    {
        name: "拓扑分析",
        path: "/topoAnalysis",
        component: () =>
            import ("views/topoAnalysis")
    },
    {
        name: "专题图",
        path: "/SpecMap",
        component: () =>
            import ("views/SpecMap")
    },
    {
        name: "应用服务",
        icon:"fa fa-globe",
